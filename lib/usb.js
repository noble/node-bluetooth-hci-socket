...
BluetoothHciSocket.prototype.bindUser = function (devId) {
    ...
    var usbVid = parseInt(process.env.BLUETOOTH_HCI_SOCKET_USB_VID) || null;
    var usbPid = parseInt(process.env.BLUETOOTH_HCI_SOCKET_USB_PID) || null;
    debug('using USB VID = ' + usbVid + ', PID = ' + usbPid);
    
    var usbBus = parseInt(process.env.BLUETOOTH_HCI_SOCKET_USB_BUS) || null;
    var usbAddress = parseInt(process.env.BLUETOOTH_HCI_SOCKET_USB_ADDRESS) || null;
